...
<br />
In this tutorial,  you will learn how to create an animated sunrise and sunset over a pyramid using CSS
...
![clip-path-demo](./demo4.png)

![clip-path-demo](./demo5.png)
